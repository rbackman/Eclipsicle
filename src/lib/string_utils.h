...
inline int indexOf(const std::string &s,char c,int pos=0){ auto p=s.find(c,pos); return p==std::string::npos?-1:(int)p; }
inline int indexOf(const std::string &s,const std::string &sub,int pos=0){ auto p=s.find(sub,pos); return p==std::string::npos?-1:(int)p; }
