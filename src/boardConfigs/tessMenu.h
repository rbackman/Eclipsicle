...
const std::map<MenuID, std::vector<ParameterID>> menuParameters = {
    ...
    {MENU_RAINBOW, {PARAM_REPEAT, PARAM_OFFSET, PARAM_TIME_SCALE, PARAM_SCROLL_SPEED, PARAM_BRIGHTNESS}},
    {MENU_DOUBLE_RAINBOW, {PARAM_TIME_SCALE, PARAM_HUE, PARAM_HUE_END, PARAM_BRIGHTNESS, PARAM_REPEAT}},
    {MENU_SLIDER_COLOR, {PARAM_HUE, PARAM_HUE_END, PARAM_WIDTH, PARAM_OFFSET, PARAM_BRIGHTNESS}},
    {MENU_SLIDER_SETTINGS, {PARAM_GRAVITY, PARAM_REPEAT, PARAM_POSITION, PARAM_MULTIPLIER, PARAM_BRIGHTNESS}},
    {MENU_RANDOM, {PARAM_RANDOM_MIN, PARAM_RANDOM_MAX, PARAM_RANDOM_ON, PARAM_RANDOM_OFF, PARAM_BRIGHTNESS}},
    {MENU_NEBULA, {PARAM_HUE, PARAM_HUE_END, PARAM_BRIGHTNESS, PARAM_NOISE_SPEED, PARAM_TIME_SCALE}},
    {MENU_BRICKS, {PARAM_HUE, PARAM_HUE_END, PARAM_WIDTH, PARAM_TIME_SCALE, PARAM_HUE_VARIANCE}},
    {MENU_PARTICLES_COLOR, {PARAM_HUE, PARAM_HUE_END, PARAM_WIDTH, PARAM_BRIGHTNESS, PARAM_SPAWN_RATE}},
    {MENU_PARTICLES_LIFE, {PARAM_LIFE, PARAM_FADE, PARAM_SPAWN_RATE, PARAM_CYCLE, PARAM_INVERT}},
    {MENU_PARTICLES_SPEED, {PARAM_TIME_SCALE, PARAM_ACCELERATION, PARAM_VELOCITY, PARAM_WIDTH, PARAM_HUE_VARIANCE}},
};
